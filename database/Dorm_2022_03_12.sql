...
start transaction;
insert into roomtemplate (Id,`RoomName`,`Size`,`Aircond`,`WaterHeater`,`TV`,`Fan`,`Rental`,`Furniture`,`Fridge`,`Enabled`)
select itemId,roomName,Size,Aircond,WaterHeater,TV,Fan,Rental,Furniture,Fridge,Enabled from room where id=rid;
insert into roomfurntemplate(`RoomId`,`Name`,`Type`,`Price`,`Model`,`Attr01`,`Attr02`,`Attr03`,`Attr04`,`Attr05`,`Attr06`)
...
-- Dump completed on 2022-03-12 20:02:14
