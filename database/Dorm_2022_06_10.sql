...
DROP TABLE IF EXISTS `changepasswordhistory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `changepasswordhistory` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `UserId` bigint NOT NULL,
  `ChangeAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `IsForgot` tinyint(1) NOT NULL DEFAULT '0',
  `SystemReset` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `forgotpassword` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `UserId` bigint NOT NULL,
  `ForgotDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Email` varchar(90) NOT NULL,
  `Token` varchar(120) NOT NULL,
  `ExpiredAt` datetime NOT NULL,
  `HasReset` tinyint(1) NOT NULL DEFAULT '0',
  `Password` int NOT NULL,
  `Expired` tinyint(1) NOT NULL DEFAULT '0',
  `Admin` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`),
  UNIQUE KEY `UserToken` (`UserId`,`Token`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `meeting` (
  ...
  `Remark` longtext,
  `IsCancel` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`,`IsCancel`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `meetingattachment`
--
...
CREATE TABLE `meetingattachment` (
  ...
  PRIMARY KEY (`Id`),
  KEY `MeetingAttachment_Meeting_idx` (`MeetingId`),
  CONSTRAINT `MeetingAttachment_Meeting` FOREIGN KEY (`MeetingId`) REFERENCES `meeting` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `meetingattendee` (
  ...
  PRIMARY KEY (`Id`),
  KEY `MeetingAttendee_Meeting_idx` (`MeetingId`),
  KEY `MeetingAttendee_Officer_idx` (`OfficerId`),
  CONSTRAINT `MeetingAttendee_Meeting` FOREIGN KEY (`MeetingId`) REFERENCES `meeting` (`Id`),
  CONSTRAINT `MeetingAttendee_Officer` FOREIGN KEY (`OfficerId`) REFERENCES `officer` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notification` (
  ...
  `SenderFrom` varchar(90) NOT NULL,
...
--
-- Table structure for table `notificationattachment`
--

DROP TABLE IF EXISTS `notificationattachment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `notificationattachment` (
  `Id` varchar(90) NOT NULL,
  `NotificationId` varchar(90) NOT NULL,
  ...
  PRIMARY KEY (`Id`),
  KEY `NA_idx` (`NotificationId`),
  CONSTRAINT `NA` FOREIGN KEY (`NotificationId`) REFERENCES `notification` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `notificationattendee`
--

DROP TABLE IF EXISTS `notificationattendee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `notificationattendee` (
  `NotificationId` varchar(90) NOT NULL,
  `UserId` bigint NOT NULL,
  `Remark` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`NotificationId`,`UserId`),
  KEY `notificationOfficer_idx` (`UserId`),
  CONSTRAINT `notification1` FOREIGN KEY (`NotificationId`) REFERENCES `notification` (`Id`),
  CONSTRAINT `notificationOfficer` FOREIGN KEY (`UserId`) REFERENCES `officer` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Changepassword`(officerId bigint,pass varchar(255),salt varchar(255),forgot tinyint(1))
BEGIN
start transaction;
update officer set Password=pass,Idx=salt where Id=officerId;
insert into changepasswordhistory(UserId,IsForgot,SystemReset) 
values(officerId,forgot,0);
commit;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_clearExpiredForgotpassword` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_clearExpiredForgotpassword`()
BEGIN
delete from forgotpassword where expired = 1 and timestampdiff(hour,expiredat,current_timestamp()) > 1;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_deletemeeting` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_deletemeeting`($meetingId bigint)
BEGIN
start transaction;
delete from meetingattendee where  MeetingId=$meetingId;
delete from meetingattachment where  MeetingId=$meetingId;
delete from meeting where id=$meetingId;
commit;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_deletenotificationafterday` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_deletenotificationafterday`(afterday int)
BEGIN
start transaction;
delete from notificationattachment where NotificationId in (select id from notification where timestampdiff(day,Date,current_timestamp()) > afterday);
delete from notificationattendee where NotificationId in (select id from notification where timestampdiff(day,Date,current_timestamp()) > afterday);
delete from notification where timestampdiff(day,Date,current_timestamp()) > afterday;
commit;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_deleteNotificationById` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_deleteNotificationById`(notiid varchar(90))
BEGIN
start transaction;
delete from notificationattachment where NotificationId=notiid;
delete from notificationattendee where NotificationId=notiid;
delete from notification where Id= notiid;
commit;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2022-06-10 11:46:12
